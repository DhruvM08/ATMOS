package com.atmos.Astronomy_service.service;

import com.atmos.Astronomy_service.model.AstronomyData;
import com.atmos.Astronomy_service.model.CurrentAstronomyDTO;
import com.atmos.Astronomy_service.model.CurrentAstronomyResponse;
import com.atmos.Astronomy_service.repository.AstronomyRepository;
...
public class WeatherAstronomyService {
    ...
    private final AstronomyRepository astronomyRepository;

    public WeatherAstronomyService(RestTemplate restTemplate, AstronomyRepository astronomyRepository) {
    ...
    public CurrentAstronomyDTO getCurrentAstronomyDTO(String city) {
        ...
        astronomyData.setCity(city);
        astronomyData.setSunrise(currentAstronomyDTO.getSunrise());
        astronomyData.setSunset(currentAstronomyDTO.getSunset());
        astronomyData.setMoonrise(currentAstronomyDTO.getMoonrise());
        astronomyData.setMoonset(currentAstronomyDTO.getMoonset());
        astronomyData.setMoonPhase(currentAstronomyDTO.getMoonPhase());
        astronomyData.setMoonIlluminance(currentAstronomyDTO.getMoonIlluminance());
        astronomyData.setVisibility(currentAstronomyDTO.getVisibility());
        astronomyData.setTimestamp(java.time.LocalDateTime.now());
        astronomyRepository.save(astronomyData);
